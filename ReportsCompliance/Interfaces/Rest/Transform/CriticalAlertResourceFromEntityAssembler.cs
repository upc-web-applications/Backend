...
public static class CriticalAlertResourceFromEntityAssembler
{
    ...
    {
        return new CriticalAlertResource(entity.Id, entity.Type, entity.Sector, entity.RiskType, entity.Message, entity.ElapsedHours, entity.Status, entity.ResponsibleSupervisor);
    }
}
