        ...
        try
        {
            ...
            if (!await context.OrgAssets.AnyAsync())
            {
                context.OrgAssets.AddRange(
                    new OrgAsset { Id = 1, Name = "Prensa Hidraulica #3", Code = "PH-003", SerialNumber = "SER-PH-2024-001", Description = "Prensa hidraulica 500 ton", Type = "Machinery", AreaId = 1, HeadquartersId = 1, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-6), AcquisitionDate = DateTime.UtcNow.AddMonths(-6), LastMaintenanceDate = DateTime.UtcNow.AddDays(-15) },
                    new OrgAsset { Id = 2, Name = "Tanque Solvente TQ-05", Code = "TQ-05", SerialNumber = "SER-TQ-2023-012", Description = "Tanque de almacenamiento de solventes", Type = "Equipment", AreaId = 2, HeadquartersId = 1, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-12), AcquisitionDate = DateTime.UtcNow.AddMonths(-12), LastMaintenanceDate = DateTime.UtcNow.AddDays(-30) },
                    new OrgAsset { Id = 3, Name = "Robot Soldador RS-200", Code = "RS-200", SerialNumber = "SER-RS-2024-008", Description = "Robot de soldadura industrial", Type = "Machinery", AreaId = 4, HeadquartersId = 2, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-3), AcquisitionDate = DateTime.UtcNow.AddMonths(-3), LastMaintenanceDate = DateTime.UtcNow.AddDays(-5) },
                    new OrgAsset { Id = 4, Name = "Cinta Transportadora CT-01", Code = "CT-01", SerialNumber = "SER-CT-2023-045", Description = "Cinta transportadora principal", Type = "Machinery", AreaId = 3, HeadquartersId = 1, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-18), AcquisitionDate = DateTime.UtcNow.AddMonths(-18), LastMaintenanceDate = DateTime.UtcNow.AddDays(-10) },
                    new OrgAsset { Id = 5, Name = "Compresor de Aire CA-100", Code = "CA-100", SerialNumber = "SER-CA-2024-003", Description = "Compresor de aire industrial", Type = "Equipment", AreaId = 6, HeadquartersId = 3, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-2), AcquisitionDate = DateTime.UtcNow.AddMonths(-2), LastMaintenanceDate = DateTime.UtcNow.AddDays(-3) },
                    new OrgAsset { Id = 6, Name = "Extractor de Gases EG-01", Code = "EG-01", SerialNumber = "SER-EG-2023-022", Description = "Sistema de extraccion de gases", Type = "Equipment", AreaId = 2, HeadquartersId = 1, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-9), AcquisitionDate = DateTime.UtcNow.AddMonths(-9), LastMaintenanceDate = DateTime.UtcNow.AddDays(-20) },
                    new OrgAsset { Id = 7, Name = "Puente Grua PG-10T", Code = "PG-10T", SerialNumber = "SER-PG-2024-006", Description = "Puente grua 10 toneladas", Type = "Machinery", AreaId = 1, HeadquartersId = 1, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-1), AcquisitionDate = DateTime.UtcNow.AddMonths(-1), LastMaintenanceDate = DateTime.UtcNow.AddDays(-2) },
                    new OrgAsset { Id = 8, Name = "Sierra Sin Fin SSF-01", Code = "SSF-01", SerialNumber = "SER-SSF-2023-031", Description = "Sierra sin fin para corte de metales", Type = "Machinery", AreaId = 4, HeadquartersId = 2, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-15), AcquisitionDate = DateTime.UtcNow.AddMonths(-15), LastMaintenanceDate = DateTime.UtcNow.AddDays(-25) },
                    new OrgAsset { Id = 9, Name = "Cabina de Pintura CP-01", Code = "CP-01", SerialNumber = "SER-CP-2024-011", Description = "Cabina de pintura electroestatica", Type = "Infrastructure", AreaId = 7, HeadquartersId = 4, Status = "Active", SystemEntryDate = DateTime.UtcNow.AddMonths(-4), AcquisitionDate = DateTime.UtcNow.AddMonths(-4), LastMaintenanceDate = DateTime.UtcNow.AddDays(-7) },
                    new OrgAsset { Id = 10, Name = "Montacargas MC-50", Code = "MC-50", SerialNumber = "SER-MC-2023-019", Description = "Montacargas industrial 5 ton", Type = "Vehicle", AreaId = 8, HeadquartersId = 4, Status = "Inactive", SystemEntryDate = DateTime.UtcNow.AddMonths(-20), AcquisitionDate = DateTime.UtcNow.AddMonths(-20), LastMaintenanceDate = DateTime.UtcNow.AddMonths(-2) }
                );
                await context.SaveChangesAsync();
            }
            ...
            if (!await context.HistoricalIncidentRecords.AnyAsync())
            {
                context.HistoricalIncidentRecords.AddRange(
                    ...
                    new HistoricalIncidentRecord { Id = "HIR_003", Sector = "Zona de Soldadura", IncidentType = "Practica insegura", Criticality = "high", IncidentDate = DateTime.UtcNow.AddDays(-3), Description = "Soldadura sin pantalla de proteccion en zona comun", Resolved = false, ClosingDate = null, ResolutionTimeHours = null, OperatorId = operarioUser!.Id }
                );
                await context.SaveChangesAsync();
            }
